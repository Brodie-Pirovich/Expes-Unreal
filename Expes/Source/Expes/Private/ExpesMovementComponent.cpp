...
//------------------------------------------------------------
void UExpesMovementComponent::ReinitializeParameter(float DeltaTime)
{
...
void UExpesMovementComponent::CalcVelocity(float DeltaTime, float Friction, bool bFluid, float BrakingDeceleration)
{
    ...
    else
    {
        ...
        {
            if (MovementStyle == EQLMovementStyle::QuakeVallina)
            {
...
void UExpesMovementComponent::HandleAirStrafeForVanilla(float MaxSpeed, float DeltaTime, float Friction, float BrakingDeceleration)
{
    if (MyCharacter.IsValid())
    {
        float moveForwardInputValue = MyCharacter->GetMoveForwardInputValue();
...
//------------------------------------------------------------
//------------------------------------------------------------
void UExpesMovementComponent::HandleAirStrafeForCPMA(float MaxSpeed, float DeltaTime, float Friction, float BrakingDeceleration)
{
    if (MyCharacter.IsValid())
    {
        float moveForwardInputValue = MyCharacter->GetMoveForwardInputValue();
